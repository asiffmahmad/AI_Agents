# Audit Project Health Prompt

## File Name
`audit-project-health.md`

## Purpose
To instruct an AI agent to perform the audit project health task.

## When To Use
Invoke this prompt when the project requires a new or updated Audit Project Health.
...
## Expected Output
A complete and professionally formatted markdown file containing the Audit Project Health.
...
Your task is to: Audit Project Health
