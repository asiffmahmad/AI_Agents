# Audit Technical Debt Prompt

## File Name
`audit-technical-debt.md`

## Purpose
To instruct an AI agent to perform the audit technical debt task.

## When To Use
Invoke this prompt when the project requires a new or updated Audit Technical Debt.
...
## Expected Output
A complete and professionally formatted markdown file containing the Audit Technical Debt.
...
Your task is to: Audit Technical Debt
