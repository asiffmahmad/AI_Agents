# Create Acceptance Criteria Document Prompt

## File Name
`create-acceptance-criteria-document.md`

## Purpose
To instruct an AI agent to perform the create acceptance criteria document task.

## When To Use
Invoke this prompt when the project requires a new or updated Create Acceptance Criteria Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Create Acceptance Criteria Document.
...
Your task is to: Create Acceptance Criteria Document
