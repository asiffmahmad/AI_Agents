# Create Architecture Decision Record Prompt

## File Name
`create-architecture-decision-record.md`

## Purpose
To instruct an AI agent to perform the create architecture decision record task.

## When To Use
Invoke this prompt when the project requires a new or updated Create Architecture Decision Record.
...
## Expected Output
A complete and professionally formatted markdown file containing the Create Architecture Decision Record.
...
Your task is to: Create Architecture Decision Record
