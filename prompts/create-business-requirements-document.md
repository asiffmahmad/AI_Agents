# Create Business Requirements Document Prompt

## File Name
`create-business-requirements-document.md`

## Purpose
To instruct an AI agent to perform the create business requirements document task.

## When To Use
Invoke this prompt when the project requires a new or updated Create Business Requirements Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Create Business Requirements Document.
...
Your task is to: Create Business Requirements Document
