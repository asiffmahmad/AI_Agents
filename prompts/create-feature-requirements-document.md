# Create Feature Requirements Document Prompt

## File Name
`create-feature-requirements-document.md`

## Purpose
To instruct an AI agent to perform the create feature requirements document task.

## When To Use
Invoke this prompt when the project requires a new or updated Create Feature Requirements Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Create Feature Requirements Document.
...
Your task is to: Create Feature Requirements Document
