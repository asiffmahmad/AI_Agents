# Create Screen Navigation Document Prompt

## File Name
`create-screen-navigation-document.md`

## Purpose
To instruct an AI agent to perform the create screen navigation document task.

## When To Use
Invoke this prompt when the project requires a new or updated Create Screen Navigation Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Create Screen Navigation Document.
...
Your task is to: Create Screen Navigation Document
