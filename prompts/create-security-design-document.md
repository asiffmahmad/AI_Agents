# Create Security Design Document Prompt

## File Name
`create-security-design-document.md`

## Purpose
To instruct an AI agent to perform the create security design document task.

## When To Use
Invoke this prompt when the project requires a new or updated Create Security Design Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Create Security Design Document.
...
Your task is to: Create Security Design Document
