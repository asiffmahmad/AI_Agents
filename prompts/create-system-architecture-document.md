# Create System Architecture Document Prompt

## File Name
`create-system-architecture-document.md`

## Purpose
To instruct an AI agent to perform the create system architecture document task.

## When To Use
Invoke this prompt when the project requires a new or updated Create System Architecture Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Create System Architecture Document.
...
Your task is to: Create System Architecture Document
