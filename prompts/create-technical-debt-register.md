# Create Technical Debt Register Prompt

## File Name
`create-technical-debt-register.md`

## Purpose
To instruct an AI agent to perform the create technical debt register task.

## When To Use
Invoke this prompt when the project requires a new or updated Create Technical Debt Register.
...
## Expected Output
A complete and professionally formatted markdown file containing the Create Technical Debt Register.
...
Your task is to: Create Technical Debt Register
