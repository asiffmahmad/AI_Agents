# Create Testing Strategy Document Prompt

## File Name
`create-testing-strategy-document.md`

## Purpose
To instruct an AI agent to perform the create testing strategy document task.

## When To Use
Invoke this prompt when the project requires a new or updated Create Testing Strategy Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Create Testing Strategy Document.
...
Your task is to: Create Testing Strategy Document
