# Create User Journey Document Prompt

## File Name
`create-user-journey-document.md`

## Purpose
To instruct an AI agent to perform the create user journey document task.

## When To Use
Invoke this prompt when the project requires a new or updated Create User Journey Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Create User Journey Document.
...
Your task is to: Create User Journey Document
