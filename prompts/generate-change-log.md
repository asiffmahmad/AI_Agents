# Generate Change Log Prompt

## File Name
`generate-change-log.md`

## Purpose
To instruct an AI agent to perform the generate change log task.

## When To Use
Invoke this prompt when the project requires a new or updated Generate Change Log.
...
## Expected Output
A complete and professionally formatted markdown file containing the Generate Change Log.
...
Your task is to: Generate Change Log
