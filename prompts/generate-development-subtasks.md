# Generate Development Subtasks Prompt

## File Name
`generate-development-subtasks.md`

## Purpose
To instruct an AI agent to perform the generate development subtasks task.

## When To Use
Invoke this prompt when the project requires a new or updated Generate Development Subtasks.
...
## Expected Output
A complete and professionally formatted markdown file containing the Generate Development Subtasks.
...
Your task is to: Generate Development Subtasks
