# Generate Release Plan Prompt

## File Name
`generate-release-plan.md`

## Purpose
To instruct an AI agent to perform the generate release plan task.

## When To Use
Invoke this prompt when the project requires a new or updated Generate Release Plan.
...
## Expected Output
A complete and professionally formatted markdown file containing the Generate Release Plan.
...
Your task is to: Generate Release Plan
