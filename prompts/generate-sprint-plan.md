# Generate Sprint Plan Prompt

## File Name
`generate-sprint-plan.md`

## Purpose
To instruct an AI agent to perform the generate sprint plan task.

## When To Use
Invoke this prompt when the project requires a new or updated Generate Sprint Plan.
...
## Expected Output
A complete and professionally formatted markdown file containing the Generate Sprint Plan.
...
Your task is to: Generate Sprint Plan
