# Project Discovery And Requirements Analysis Prompt

## File Name
`project-discovery-and-requirements-analysis.md`

## Purpose
To instruct an AI agent to perform the project discovery and requirements analysis task.

## When To Use
Invoke this prompt when the project requires a new or updated Project Discovery And Requirements Analysis.
...
## Expected Output
A complete and professionally formatted markdown file containing the Project Discovery And Requirements Analysis.
...
Your task is to: Project Discovery And Requirements Analysis
