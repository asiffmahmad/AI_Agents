# Project Glossary And Domain Terminology Prompt

## File Name
`project-glossary-and-domain-terminology.md`

## Purpose
To instruct an AI agent to perform the project glossary and domain terminology task.

## When To Use
Invoke this prompt when the project requires a new or updated Project Glossary And Domain Terminology.
...
## Expected Output
A complete and professionally formatted markdown file containing the Project Glossary And Domain Terminology.
...
Your task is to: Project Glossary And Domain Terminology
