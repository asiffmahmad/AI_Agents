# Review System Architecture Prompt

## File Name
`review-system-architecture.md`

## Purpose
To instruct an AI agent to perform the review system architecture task.

## When To Use
Invoke this prompt when the project requires a new or updated Review System Architecture.
...
## Expected Output
A complete and professionally formatted markdown file containing the Review System Architecture.
...
Your task is to: Review System Architecture
