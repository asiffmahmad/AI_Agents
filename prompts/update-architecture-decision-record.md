# Update Architecture Decision Record Prompt

## File Name
`update-architecture-decision-record.md`

## Purpose
To instruct an AI agent to perform the update architecture decision record task.

## When To Use
Invoke this prompt when the project requires a new or updated Update Architecture Decision Record.
...
## Expected Output
A complete and professionally formatted markdown file containing the Update Architecture Decision Record.
...
Your task is to: Update Architecture Decision Record
