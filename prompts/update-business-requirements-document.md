# Update Business Requirements Document Prompt

## File Name
`update-business-requirements-document.md`

## Purpose
To instruct an AI agent to perform the update business requirements document task.

## When To Use
Invoke this prompt when the project requires a new or updated Update Business Requirements Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Update Business Requirements Document.
...
Your task is to: Update Business Requirements Document
