# Update Database Design Document Prompt

## File Name
`update-database-design-document.md`

## Purpose
To instruct an AI agent to perform the update database design document task.

## When To Use
Invoke this prompt when the project requires a new or updated Update Database Design Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Update Database Design Document.
...
Your task is to: Update Database Design Document
