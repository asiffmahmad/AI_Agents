# Update Screen Navigation Document Prompt

## File Name
`update-screen-navigation-document.md`

## Purpose
To instruct an AI agent to perform the update screen navigation document task.

## When To Use
Invoke this prompt when the project requires a new or updated Update Screen Navigation Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Update Screen Navigation Document.
...
Your task is to: Update Screen Navigation Document
