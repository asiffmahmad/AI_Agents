# Update Security Design Document Prompt

## File Name
`update-security-design-document.md`

## Purpose
To instruct an AI agent to perform the update security design document task.

## When To Use
Invoke this prompt when the project requires a new or updated Update Security Design Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Update Security Design Document.
...
Your task is to: Update Security Design Document
