# Update Technical Debt Register Prompt

## File Name
`update-technical-debt-register.md`

## Purpose
To instruct an AI agent to perform the update technical debt register task.

## When To Use
Invoke this prompt when the project requires a new or updated Update Technical Debt Register.
...
## Expected Output
A complete and professionally formatted markdown file containing the Update Technical Debt Register.
...
Your task is to: Update Technical Debt Register
