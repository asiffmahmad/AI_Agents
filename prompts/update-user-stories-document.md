# Update User Stories Document Prompt

## File Name
`update-user-stories-document.md`

## Purpose
To instruct an AI agent to perform the update user stories document task.

## When To Use
Invoke this prompt when the project requires a new or updated Update User Stories Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Update User Stories Document.
...
Your task is to: Update User Stories Document
