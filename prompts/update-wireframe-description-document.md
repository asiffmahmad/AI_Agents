# Update Wireframe Description Document Prompt

## File Name
`update-wireframe-description-document.md`

## Purpose
To instruct an AI agent to perform the update wireframe description document task.

## When To Use
Invoke this prompt when the project requires a new or updated Update Wireframe Description Document.
...
## Expected Output
A complete and professionally formatted markdown file containing the Update Wireframe Description Document.
...
Your task is to: Update Wireframe Description Document
